...
<body>
    ...
    <div id="container">
        <div id="terms_div" class="div_center">
            ...
            <div id="terms_detail">
                <p>真诚地感谢您的参与!即将开始的实验类似于调查问卷,我们将会列出一些设计竞赛的作品(图),<b>您需要对作品进行两两比较,
                评价出在创新性或实用性上较为优秀的一个</b>. 大部分问题的答案我们自己也不明确,所以尽力选择就好. </p>

                <p><b>实验时间约5-15分钟/组，每组15个单选题</b>，我们会记录您的答题信息(包括您的点击信息及操作时间等数据), 任务完成后将会向您索取支付宝账号, 以便支付报酬. </p>

                <p style="color: deeppink">请注意:<br/>1.实验中出现的设计作品, 其版权归原作者所有, 请勿下载或挪作商用. <br/>
                    2.请勿使用自动化方法或随意点击完成实验或违反其他实验约定,一经发现将<b>取消或降低支付报酬</b>.<br/>
                    3.题目中将随机出现检测参与质量的问题，请认真作答.<br/>
                </p>
                ...
                <p>酬金支付将采用支付宝转账的形式，正常情况下实验完成后10个工作日内可到账，支付到账记录可在本站查询.</p>
